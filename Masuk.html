            ...
            <div class="w-screen bg-secondary2 rounded-3xl shadow md:mt-0 max-w-xs sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-2 md:space-y-6" action="#">
                        ...
                        <div class="flex mx-5 w-10/12 lg:mx-12 lg:w-9/12 px-12 items-center my-3 before:flex-1 before:border-t before:border-primary2 before:mt-0.5 after:flex-1 after:border-t after:border-primary2 after:mt-0.5">
                            <p class="text-center font-semibold mx-4 mb-0">OR</p>
                        </div>
                        <a class="mx-5 w-10/12 lg:mx-12 lg:w-9/12 font-poppins font-bold text-lg leading-5 rounded-xl text-primary2 bg-secondary2 border-2 border-primary2 hover:bg-primary3 hover:text-secondary3 px-6 py-3 shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex justify-center items-center mb-3"
                        href="#!"
                        role="button"
                        data-mdb-ripple="true"
                        data-mdb-ripple-color="light">
                        <!-- Google -->
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" class="w-6 h-6 mr-2 fill-primary2">
